...
current_list = file_lists{i} % Select a file list
    ...
    var_series = [];
        ...
        var_table.Properties.VariableNames = {'hr','prec','snowfall','temp','u10','v10','date'}; % Rename the columns
...
var_list2 = var_list_struct.var_list2;  % Access the first field (var_list1)
first_table = var_list2{1};  % Extract the first table from the cell array

plot(concat_table{:, 7}, concat_table{:, 1}, '-o');
