...
folder = '/media/ddonoso/Pengo2/Doctorado/datos_netcdf_rema/netcdf_era5land';
...
nan_info = true(21,21); % 2D array with 0 or 1, representing NaN or non-NaNs in ncfile.
...
folderPath = '/home/ddonoso/Desktop/datos_Albert/era5land_fossilbluff/';
fn = sprintf ('%s/coords_era5land_fossilbluff.csv', folderPath);
...
for i = 18%1:size(stations, 1)
    ...
    var_table.Properties.VariableNames = {'dew','temp','snowfall','u10','v10','pres','prec','date'}; % Rename the columns
